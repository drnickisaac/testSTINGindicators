...
I've set beta1, beta2, psi & mu.p1 as initial values in this simulation model: is this the same as fixing them? Or should they go in constants?
...
runMCMC_samples <- runMCMC(CoccMCMC, nburnin = 15000, niter = 20000, nchains = 3, samplesAsCodaMCMC = T)
```
...
```
With the current setup, the phenology parameters are estimated rather poorly (beta2 has been over-estimated)
Possibly this is why mu.p1 has been under-estimated, although it could be an error somewhere in the code.
